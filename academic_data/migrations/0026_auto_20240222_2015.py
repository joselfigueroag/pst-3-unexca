# Generated by Django 4.2.3 on 2024-02-23 00:15
    ...
    CREATE OR REPLACE VIEW public.academic_notes_all
        AS
            SELECT DISTINCT stu.id AS student_id,
                stu.first_name AS nombre,
                stu.first_surname AS apellido,
                gra.year AS grado,
            ...
            WHERE aca.grade_id = gra.id AND sec.id = aca.section_id AND per.id = aca.academic_period_id AND tur.id = aca.shift_id;
